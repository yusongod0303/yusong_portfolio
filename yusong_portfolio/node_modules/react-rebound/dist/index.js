...
var rebound__default = _interopDefault(rebound);
...
var springSystem = new rebound__default.SpringSystem();
...
function createSpring(startValue, tension, friction) {
    ...
    if (Array.isArray(startValue)) {
        spring = new MultiSpring(springSystem, new rebound.SpringConfig(tension, friction));
        spring.setCurrentValue(startValue);
    }
    else {
        spring = springSystem.createSpringWithConfig(new rebound.SpringConfig(tension, friction));
        spring.setCurrentValue(startValue);
    }
    return spring;
}
